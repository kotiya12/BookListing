...
const BookTable = ({handleSort,books,handleEdit,currentPage,handleChangePage,sortDirection}) => {
  return (
    <div>
        ...
        <TableHead style={{ backgroundColor: "gray" }}>
          ...
          <TableBody>
            {books && books.length > 0 &&
              books.slice((((currentPage+1) * 5) - 5) , ((currentPage+1) * 5)).map((book) => (
              ...
              <TableCell><button onClick={() => handleEdit(book)}>Edit</button></TableCell>
